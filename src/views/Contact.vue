<template>
  <div id="contact">
    <div class="contact md-auto px-6 sm:px-24 pt-28 pb-0 overflow-x-hidden">
      ...
      <div class="text-md text-gray-300">请发送表单或发邮至 chreta.com@gmail.com 与我们进行联系</div>
      <div class="relative max-w-xl mx-auto pt-12">
        <svg fill="none" viewBox="0 0 404 404" width="404" height="404" class="absolute transform translate-x-1/2 left-full 2xl:translate-x-3/4"><defs><pattern id="square" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><rect x="0" y="0" width="4" height="4" fill="currentColor" class="text-gray-200"></rect></pattern></defs> <rect width="404" height="784" fill="url(#square)"></rect></svg>
        <svg fill="none" viewBox="0 0 404 404" width="404" height="404" class="absolute bottom-0 transform -translate-x-1/2 2xl:-translate-x-3/4 right-full"><defs><pattern id="square" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><rect x="0" y="0" width="4" height="4" fill="currentColor" class="text-gray-200"></rect></pattern></defs> <rect width="404" height="784" fill="url(#square)"></rect></svg>
        <el-form :model="form" ref="form" :rules="rules" label-position="right" label-width="auto">
          ...
          <el-form-item>
            <el-button class="w-full" type="primary" @click="submit('form')">提交</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <section class="py-4 px-6 sm:py-12 sm:px-24 sm:pb-24">
      <div class="flex flex-wrap items-center justify-around pt-6 sm:pt-10">
        <div class="w-full md:w-1/4 flex flex-wrap flex-col items-center justify-center pt-6" v-for="(contact, index) in contactList" :key="index">
