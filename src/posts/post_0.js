  ...
  contentList: [
    ...
    },
    {
      ...
      value: [
        ...
        '\xa0\xa0\xa0 ● Android 中的操作系统模块，包括蓝牙和 Keystore 2.0',
        '\xa0\xa0\xa0 ● 低级别的项目，例如 ChromeOS 中使用的 crosvm 虚拟机监视器和驱动程序（QEMU 的替代方案）',
        '\xa0\xa0\xa0 ● 为使用 Rust 的开源项目做出的贡献，例如 Mercurial 源代码控制系统',
        '\xa0\xa0\xa0 ● 固件的 FIDO 安全密钥支持',
        '',
        '此外，还有许多其他项目正在评估 Rust 在新的库或产品中的使用情况。一些例子包括：',
        '\xa0\xa0\xa0 ● 软件国际化项目，ICU4X',
        '\xa0\xa0\xa0 ● 部分新实验操作系统 Fuchsia',
        '\xa0\xa0\xa0 ● GPU 字体渲染的研究',
        '',
        '谷歌所支持的 Rust 项目及其维护者有：',
        '\xa0\xa0\xa0 ● 在 curl 中添加 Rust 代码',
        '\xa0\xa0\xa0 ● 与 ISRG 合作，将 Rust TLS 模块添加到 Apache HTTP 服务器项目',
